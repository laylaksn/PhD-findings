...
%========================================================================
    ...
    phi=@(x,y) sin(pi*x)*sin(pi*y)+(x.^2-1)*(y.^2-1) ; 
    ...
    for i=1:Kx %for each element in x
        ...
        for k=1:Ky   
            ...
            Fxy = (2)*(pi^2)*sin(pi*physx).*(sin(pi*physy')) -2*(physx.^2)-2*(physy'.^2)+4 ;
...
%=========================================================================
    ...
    endTime(Num) = cputime;  
    enrichmentTime(Num) = endTime(Num) - startTime(Num); 
...
fprintf('L2 errors for Example 5, i=2, using the LS SEM PGD, after two enrichments:')
fprintf('\n');
fprintf('\n'); 
fprintf('N =       ');
fprintf('%8d ', Nvalues);
...
fprintf('\n');
fprintf('%d and %d ADFPA iterations required at the first and second enrichment stages, respectively, for Example 5, i=2, using the LS SEM PGD, with epsilon = %6.2e\n', ...
