...
%========================================================================
    ...
    for i=1:Kx %for each element in x
        ...
        for k=1:Ky   
            ...
            Fxy = (2)*(pi^2)*sin(pi*physx).*(sin(pi*physy'));
...
%=========================================================================
    ...
    for term = 1:no_enrichment
        ...
        % cumTime(term) = cumTime(term) + enrichmentTime;
        ...
        L2phi(Num)=QL2phierror; 
        L2u(Num)=QL2uerror; 
        L2v(Num)=QL2verror; 
    end


each_count_b(Num,:) = each_count_value;
end
...
fprintf('\n');
fprintf('Number of ADFPA iterations required at the first enrichment stage for Example 9 using the LS SEM PGD, with epsilon =  %6.2e', epsilon)
fprintf('\n');
fprintf('\n'); 
fprintf('N =          ');
fprintf('%8d ', Nvalues);
