...
T = array2table(A, ...
    ...
    'RowNames', rowLabels);
fprintf('\n');
fprintf('L2 errors for φ for Example 6 using the LS SM PGD, after one enrichment with N=24:')
fprintf('\n');
disp(T)
...
T = array2table(allb_cumcounter, ...
    ...
    'RowNames', rowLabels);
fprintf('\n');
fprintf('Number of ADFPA iterations required at the first enrichment stage for Example 6 using the LS SM PGD, for N=24 and epsilon = %6.2e\n', epsilon )
fprintf('\n');
disp(T)
