...
%=======================================================================   
    ...
    node_transpose = node';
    % source term
    F=2*pi^2*sin(pi*node)*sin(pi*node_transpose);
...
fprintf('L2 errors for Example 11, i = 3, using the MLS SM PGD, after one enrichment:')
fprintf('\n');
fprintf('\n');
fprintf('N =       ');
fprintf('%8d   ', Nvalues);
