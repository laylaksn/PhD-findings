...
for number=1:length(Nvalues)
    ...
    for xx=1:numel(nodex)
        for yy=1:numel(nodey)
            ...
            PPP(xx,yy) = sin(pi*nodex(xx)*nodey(yy));
    ...
    for x=1:numel(xx)
        for y=1:numel(xx)
                F1(x,y) = pi*xx(y)*cos(pi*xx(x)*xx(y))-(4*pi^2*sin(2*pi*xx(y)))*(2*cos(2*pi*xx(x))-1) ;
                F2(x,y) = pi*xx(x)*cos(pi*xx(x)*xx(y))+(4*pi^2*sin(2*pi*xx(x)))*(2*cos(2*pi*xx(y))-1) ;
        end
    end
...
set(gcf, 'Color', 'white')
handles = semilogy(1:no_enrichment,L2Uvec, 'Linewidth', 2);
set(gca,'fontsize',14);
legend('$N=12$','$N=16$','$N=20$','$N=24$','interpreter','latex','FontSize', 20 )
xlabel('$Q$ enrichments','interpreter','latex','fontsize',20)
ylabel('$L^{2}$ Error','interpreter','latex','fontsize',20)
grid on
set(gca,'xlim',[1 no_enrichment]);

figure('Units', 'normalized', 'Position', [0.2 0.2 0.5 0.5]);;
set(gcf, 'Color', 'white') 
handles= semilogy(1:no_enrichment,L2P, 'Linewidth', 2);
set(gca,'fontsize',14);
legend('$N=12$','$N=16$','$N=20$','$N=24$','interpreter','latex','FontSize', 20)
xlabel('$Q$ enrichments','interpreter','latex','fontsize',20) 
set(gca,'xlim',[1 no_enrichment]);
...
figure('Units', 'normalized', 'Position', [0.2 0.2 0.5 0.5]);
set(gcf, 'Color', 'white') 
handles=plot(1:no_enrichment, executionTimes, 'Linewidth', 2) 
set(gca,'xlim',[1 no_enrichment]);
set(gca,'fontsize',14);
legend('$N=12$','$N=16$','$N=20$','$N=24$','interpreter','latex','FontSize', 20, 'Location', 'northwest' )
grid on
xlabel('$Q$ enrichments','interpreter','latex','fontsize',20)
...
figure('Units', 'normalized', 'Position', [0.2 0.2 0.5 0.5]);
set(gca,'fontsize',14);
handles = plot(1:no_enrichment, allb_cumcounter, 'Linewidth', 2);
set(gca,'fontsize',14);
grid on
legend('$N=12$','$N=16$','$N=20$','$N=24$','interpreter','latex','FontSize', 20, 'Location', 'northwest' )
ylabel('Cumulative iterations','interpreter','latex','fontsize',20)
xlabel('$Q$ enrichments','interpreter','latex','fontsize',20)
